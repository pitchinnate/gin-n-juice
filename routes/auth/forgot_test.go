...
func TestForgot(t *testing.T) {
	...
	t.Run("Test Forgot Password Empty", func(t *testing.T) {
		body, _ := json.Marshal(gin.H{})
		w := tester.SetupTestRouter("POST", PostForgot, body)

		assert.Equal(t, http.StatusBadRequest, w.Code, w.Body.String())
	})
	t.Run("Test Forgot Password Bad Params", func(t *testing.T) {
	...
	t.Run("Test Forgot Password Email Not Found", func(t *testing.T) {
	...
	t.Run("Test Forgot Password Email Found", func(t *testing.T) {
		user := models.User{
			Email:    "test@test.com",
			Password: "test",
			Admin:    false,
